...
<template>
  <div class="tools-container__anchor-menu-title">Быстрая навигация</div>
  <nav class="tools-container__anchor-menu">
    <div class="tools-container__anchor-item"><a href="#calc-bet">Ставка</a></div>
    <div class="tools-container__anchor-item"><a href="#calc-cubes">Кубы</a></div>
    <div class="tools-container__anchor-item"><a href="#calc-gems">Самоцветы</a></div>
